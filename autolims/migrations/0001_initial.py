# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-24 20:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('liquid_transfer_in', 'liquid_transfer_in'), ('liquid_transfer_out', 'liquid_transfer_out'), ('instructions', 'instructions')], default='liquid_transfer_in', max_length=200)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('aliquot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliquot_effects', related_query_name='aliquot_effect', to='autolims.Aliquot')),
            ],
        ),
        migrations.CreateModel(
            name='Container',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subdomain', models.CharField(db_index=True, max_length=200, unique=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_condition', models.CharField(blank=True, choices=[(b'cold_4', b'cold_4'), (b'cold_20', b'cold_20'), (b'cold_80', b'cold_80'), (b'warm_37', b'warm_37'), (b'ambient', b'ambient')], default=b'ambient', max_length=200, null=True)),
                ('sensitivities', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=list, null=True)),
                ('properties', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('kind', models.CharField(choices=[('accepted', 'accepted'), ('in_progress', 'in_progress'), ('complete', 'complete'), ('aborted', 'aborted'), ('canceled', 'canceled')], default='available', max_length=200)),
                ('transcriptic_id', models.CharField(blank=True, db_index=True, default='', max_length=200, null=True, unique=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('accepted', 'accepted'), ('in_progress', 'in_progress'), ('complete', 'complete'), ('aborted', 'aborted'), ('canceled', 'canceled')], default='available', max_length=200)),
                ('test_mode', models.BooleanField(default=False)),
                ('completed_at', models.DateTimeField(blank=True, null=True)),
                ...
                ('properties', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('protocol', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='run_containers', related_query_name='run_container', to='autolims.Container')),
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='run_containers', related_query_name='run_container', to='autolims.Run')),
            ],
        ),
        migrations.AddField(
            model_name='run',
            name='containers',
            field=models.ManyToManyField(blank=True, null=True, related_name='runs', related_query_name='run', through='autolims.RunContainer', to='autolims.Container'),
        ),
        migrations.AddField(
            model_name='run',
            name='owner',
        ...
        migrations.AddField(
            model_name='run',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='runs', related_query_name='run', to='autolims.Project'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='container',
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='containers', related_query_name='container', to='autolims.Organization'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='aliquot',
            name='container',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliquots', related_query_name='aliquot', to='autolims.Container'),
        ),
        migrations.AlterUniqueTogether(
            name='runcontainer',
            unique_together=set([('run', 'container_label')]),
        ),
