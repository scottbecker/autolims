    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('liquid_transfer_in', 'liquid_transfer_in'), ('liquid_transfer_out', 'liquid_transfer_out'), ('instruction', 'instruction')], default='liquid_transfer_in', max_length=200)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transcriptic_id', models.CharField(blank=True, default='', max_length=200, null=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='autolims.Container')),
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='autolims.Run')),
            ],
        ),
        migrations.AddField(
            model_name='run',
            name='containers',
            field=models.ManyToManyField(blank=True, null=True, related_name='runs', related_query_name='run', through='autolims.RunContainers', to='autolims.Container'),
        ),
        migrations.AddField(
            model_name='run',
            name='owner',
