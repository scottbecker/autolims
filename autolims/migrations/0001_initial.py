    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('kind', models.CharField(choices=[('complete', 'complete'), ('accepted', 'accepted'), ('in_progress', 'in_progress'), ('aborted', 'aborted'), ('canceled', 'canceled')], default='available', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('autoprotocol', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
